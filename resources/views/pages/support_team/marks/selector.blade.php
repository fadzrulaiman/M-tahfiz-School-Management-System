            ...
            <div class="col-md-10">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="my_class_id" class="col-form-label font-weight-bold">Form:</label>
                                <select required onchange="getClassSubjects(this.value)" id="my_class_id" name="my_class_id" class="form-control select" data-placeholder="Select form">
                                    <option value=""></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select required id="section_id" name="section_id" data-placeholder="Select Form First" class="form-control select">
                                   @if($selected)
