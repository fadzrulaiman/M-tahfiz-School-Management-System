...
<div class="navbar navbar-expand-md navbar-dark" style="background-color:#00C897;">
@elseif(Auth::user()->user_type == 'parent')
<div class="navbar navbar-expand-md navbar-dark" style="background-color:#3282B8;">
@elseif(Auth::user()->user_type == 'teacher')
<div class="navbar navbar-expand-md navbar-dark" style="background-color:#7CD1B8;">
@else
