    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-4"><h6 class="card-title"><strong>Form: </strong> {{ $my_class->name }}</h6></div>
            ...
            <div class="card-body">
                <table class="table table-responsive table-striped">
                    <thead>
                    <tr>
                        <th rowspan="2">Time <i class="icon-arrow-right7 ml-2"></i> <br> Day<i class="icon-arrow-down7 ml-2"></i>
                        </th>
