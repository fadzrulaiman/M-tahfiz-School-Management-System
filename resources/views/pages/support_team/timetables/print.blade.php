...
<div class="container">
    <div id="print" xmlns:margin-top="http://www.w3.org/1999/xhtml">
        ...
        <table width="100%">
            <tr>
                <td >
                    <strong><span style="color: #1b0c80; font-size: 25px;">M-tahfiz</span></strong><br/>
                    ...
                    <br /> <br />
                    <strong><span style="color: #000; font-size: 15px;"> TIMETABLE FOR {{ strtoupper($my_class->name. $ttr->name. ' ('.$ttr->year.')' ) }}
                    </span></strong>
                </td>
            </tr>
        </table>
